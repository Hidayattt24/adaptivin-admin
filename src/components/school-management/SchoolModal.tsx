            ...
            <form onSubmit={handleSubmit} className="p-6 lg:p-8 overflow-y-auto max-h-[calc(90vh-200px)]">
              ...
              <div className="flex items-center justify-end gap-3 lg:gap-4 mt-8 pt-6 border-t border-gray-200">
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center gap-2 px-4 lg:px-6 py-2 lg:py-3 rounded-xl bg-linear-to-r from-primary to-primary-dark text-white font-semibold hover:shadow-lg transition-all text-sm lg:text-base"
                >
                  <Save sx={{ fontSize: 20 }} />
