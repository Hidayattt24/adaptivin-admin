...
export default function UserTable() {
  ...
  const classes = ["Semua Kelas", "III", "IV", "V"];
                    ...
                    <td className="px-4 py-4">
                      <span
                        className={`px-4 py-1.5 rounded-lg text-xs font-bold text-white shadow-sm ${
                          user.role === "Murid" ? "bg-gradient-to-r from-green-500 to-green-600" : "bg-gradient-to-r from-blue-500 to-blue-600"
                        }`}
                      >
                        {user.role}
                      </span>
